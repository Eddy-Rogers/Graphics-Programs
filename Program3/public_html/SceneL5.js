...
Scene.prototype.Redraw = function() {
  ...
  camera.near = this.nearSlider.valueAsNumber;
  camera.far = this.farSlider.valueAsNumber;
  camera.location[0] = this.camxSlider.valueAsNumber;
  camera.location[1] = this.camySlider.valueAsNumber;
  camera.location[2] = this.camzSlider.valueAsNumber;
